...
export default function Footer() {
    return (
        <div className="flex-nowrap bg-white md-lg:gap-4 md-lg:flex-wrap md-lg:px-16 bg-white-light text-black font-[500] mt-[8rem] px-4 rounded py-8 text-center md-lg:text-start" style={{ boxShadow: '1px 1px 2px rgb(92, 90, 90)' }}>
            <div className="flex flex-col gap-8 md-lg:flex-row md-lg:justify-between md-lg:max-w-[85%] md-lg:m-auto">
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <a className="hover:underline" href="">Biografia</a>
                    </div>
                </div>
                <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6">
                    <h2 className="font-[800] text-[1.1rem] text-blue">Ajuda</h2>
                    <div className="flex flex-col gap-2">
                        <a className="hover:underline" href="">Suporte</a>
                    </div>
                </div>
                <div className="flex flex-col gap-6">
                    <h2 className="font-[800] text-[1.1rem] text-blue">Contatos</h2>
                    <div className="flex gap-2 justify-center md-lg:justify-start">
                        <a href="https://www.instagram.com/liedson.vue">
                        ...
                        <a href="https://wa.me/86998635571?text=Olá%20vamos%20criar%20algo%20extraordinário!">
            ...
            <div>
                <p className="text-center mt-4 md-lg:mt-12 font-bold">Todos os direitos reservados ©Liedson Barros 2024</p>
            </div>
        </div>
    )
}