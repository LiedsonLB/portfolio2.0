...
export default function AboutMe() {
    return (
        <div className="my-20 py-20 bg-black" id="aboutMe">
            <h1 className="big-text font-doppio font-[800] text-center mb-4 text-white" style={{ fontSize: 'clamp(30px, 5vw + 0.2rem, 50px)' }}>Sobre <span className="text-blue">mim</span></h1>
